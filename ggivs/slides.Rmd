...
To see this output, run this in your RStudio.  The output wil be in the Viewer pane. Ideally, this interactive output is done in concert with Shiny.  learn more about itneractivity at the [ggvis-interactive documentation](http://ggvis.rstudio.com/interactivity.html).
